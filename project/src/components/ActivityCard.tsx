...
import { Clock, Users, ShoppingCart, Sunset, Image } from 'lucide-react';
...
export function ActivityCard({ activity, onAddToCart }: ActivityCardProps) {
  ...
  const hasGallery = activity.gallery_images && activity.gallery_images.length > 0;
        ...
        <div className="relative h-64 overflow-hidden">
          ...
          {hasGallery && (
            <button
              ...
              className="absolute top-4 right-4 bg-black/60 hover:bg-black/80 text-white px-3 py-1 rounded-lg text-sm flex items-center gap-2"
            >
